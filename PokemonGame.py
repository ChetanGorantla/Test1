...
def play():
    while True:
        p_choice = str(input("Welcome, which pokemon would youy like to choose?\n '1': 'Charmander'\n'2':'Squirtle'\n"
                             "'3': 'Bulbasur'"))
        if p_choice == '1':
            p_choice = 'Charmander'
        elif p_choice == '2':
...
# Computer part
        ...
        def battle():
            ...
            if p_choice == cpu_choice:
                print("{} and {} have the same power so they started to mingle about their powers.".format(cpu_choice, p_choice))
                play_again = input("Do you want to play again?")

            elif p_choice == 'Charmander' and cpu_choice == 'Squirtle':
                print("{} used water splash to wash down the fire of {}".format(cpu_choice,p_choice))
                play_again = input("Do you want to play again?")
            # elif p_choice == 'Squirtle' and cpu_choice == 'Charmander':
               # print("{} and {} used water splash to wash down the fire of {}")
            # elif p_choice == 'Bulbasur' and cpu_choice == 'Charmander':
               # print("{} has burned into a crisp because of fire flames from {}".format(p_choice,cpu_choice))
